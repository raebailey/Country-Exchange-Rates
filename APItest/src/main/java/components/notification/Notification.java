...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message,Image image) {
    	FlatDarkLaf.setup();
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/success.png")));
        ...
        if(image!=null) {
        	cmdClose.setIcon(new javax.swing.ImageIcon(image.getScaledInstance(60, 48, Image.SCALE_SMOOTH)));
        }
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/success.png"))); // NOI18N
